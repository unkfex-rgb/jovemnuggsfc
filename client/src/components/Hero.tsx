...
export default memo(function Hero() {
  ...
  const totalAssists = Object.values(stats?.players || {}).reduce(
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          <div className="bg-black border border-cyan-400/50 p-4" style={{
            ...
            <div className="text-3xl font-900 text-white mb-1">{totalMatches}</div>
          ...
          <div className="bg-black border border-cyan-400/50 p-4" style={{
            ...
            <div className="text-3xl font-900 text-white mb-1">{wins}</div>
          ...
          <div className="bg-black border border-cyan-400/50 p-4" style={{
            ...
            <div className="text-3xl font-900 text-white mb-1">{totalGoals}</div>
          ...
          <div className="bg-black border border-cyan-400/50 p-4" style={{
            ...
            <div className="text-3xl font-900 text-white mb-1">{totalAssists}</div>
