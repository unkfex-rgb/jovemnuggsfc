...
import { getInitials, getPositionLabel, calculatePlayerScore } from '../lib/playerUtils';
            ...
            <div className="relative px-8 py-6">
              ...
              <div className="flex items-start gap-6 mb-8">
                <motion.div
                  ...
                  className="w-24 h-24 flex items-center justify-center font-orbitron font-900 text-5 text-black bg-white border-2 border-cyan-400 flex-shrink-0" style={{
        ...
        <div className="relative bg-black border border-cyan-400/40 group-hover:border-cyan-400/80 p-5 transition-all duration-300 overflow-hidden" style={{
          ...
          <div className="relative z-10">
            ...
            <motion.div
              ...
              className="w-16 h-16 rounded-none mx-auto mb-4 flex items-center justify-center font-orbitron font-900 text-5 text-black bg-white border-2 border-cyan-400 group-hover:border-cyan-300 transition-all duration-300" style={{
